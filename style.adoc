...
* NOTA
+
Utilice LA NOTA para obtener información importante que debe ser distinta del resto del texto. Evite utilizar LA NOTA para obtener información que no sea necesaria para que los usuarios aprendan sobre la tarea o la completen.
